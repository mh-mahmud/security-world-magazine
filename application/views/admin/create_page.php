                                                ...
                                                <form method="post" action=""  enctype="multipart/form-data" id="" class="form-horizontal">
                                                    ...
                                                    <fieldset>
                                                          ...
                                                          <div class="control-group">
                                                            <label class="control-label">Head Page Name</label>
                                                            <div class="controls">
                                                              <select class="span6 m-wrap" name="sub_category_id">
                                                                <option value="">Select...</option>
                                                                <?php
                                                                  if(count($edit['PAGE_ID'])) {
                                                                    $options = $this->db->query("SELECT * FROM sub_category")->result();
                                                                  } else {
                                                                    $options = $this->db->query("select c.CATEGORY_NAME, sc.* FROM category as c inner join sub_category as sc on c.CATEGORY_ID = sc.CAT_ID WHERE c.CATEGORY_NAME = 'Page' AND sc.STATUS = 7")->result();
                                                                  }
                                                                ?>
                                                          ...
                                                          <div class="control-group">
                                                            <label class="control-label">Sub Page Name</label>
                                                            <div class="controls">
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <textarea id="my_textarea" rows="10" cols="50" name="page_details" data-required="1" class="span6 m-wrap" ><?php echo set_value('details',$edit['PAGE_DETAILS']); ?></textarea>
