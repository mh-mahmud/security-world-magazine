      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm6">
          <div class="latest_slider">
            ...
            <?php
              $slider = $this->db->query("SELECT * FROM news ORDER BY NEWS_ID ASC LIMIT 3")->result();
              foreach($slider as $v) :
            ?>
              <div class="single_iteam">
                <?php if( file_exists($this->webspice->get_path('banner_full').$v->NEWS_BANNER_IMAGE) ): ?>
                    <img src="<?php echo $this->webspice->get_path('banner').$v->NEWS_BANNER_IMAGE; ?>"  alt="" class="img-responsive"/>
                <?php endif;  ?>
                <h2><a class="slider_tittle" href="pages/single.html"><?php echo $v->NEWS_TITLE; ?></a></h2>
              </div>
            <?php endforeach; ?>
            </div>
          </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm6">
          <div class="content_top_right">
            ...
            <?php
              $front = $this->db->query("SELECT * FROM news LIMIT 4")->result();
              foreach($front as $f) :
            ?>

              <li>
                <?php if( file_exists($this->webspice->get_path('small_full').$f->NEWS_SMALL_IMAGE) ): ?>
                    <img src="<?php echo $this->webspice->get_path('small').$f->NEWS_SMALL_IMAGE; ?>"  alt="" class="img-responsive" width="100px;"/>
                <?php endif;  ?>
                <div class="title_caption">
                  <a href="pages/single.html"><?php echo $f->NEWS_TITLE; ?></a>
                </div>
              </li>
      ...
      <div class="col-lg-3 col-md-3 col-sm-3">
        <div class="content_middle_leftbar">
          <div class="single_category wow fadeInDown">
            ...
            <ul class="catg1_nav">
              <li>
                <div class="catgimg_container"> <a href="pages/single.html" class="catg1_img"><img alt="" src="<?php echo $url_prefix; ?>global/images/292x150x1.jpg"></a></div>
                <h3 class="post_titile"><a href="pages/single.html">Vestibulum ut est augue, in varius</a></h3>
              </li>
              <li>
                <div class="catgimg_container"> <a href="pages/single.html" class="catg1_img"><img alt="" src="<?php echo $url_prefix; ?>global/images/292x150x2.jpg"></a></div>
                <h3 class="post_titile"><a href="pages/single.html">Vestibulum ut est augue, in varius</a></h3>
              </li>
            </ul>
          </div>
      ...
      <div class="col-lg-6 col-md-6 col-sm-6">
        <div class="content_middle_middle">
          <div class="slick_slider2">
            <div class="single_featured_slide"> <a href="pages/single.html"><img src="<?php echo $url_prefix; ?>global/images/567x330x1.jpg" alt=""></a>
            ...
            <div class="single_featured_slide"> <a href="pages/single.html"><img src="<?php echo $url_prefix; ?>global/images/567x330x2.jpg" alt=""></a>
              <h2><a href="#">Praesent vitae quam vitae arcu posuer 2</a></h2>
              <p>Nunc tincidunt, elit non cursus euismod, lacus augue ornare metus, egestas imperdiet nulla nisl quis mauris. Suspendisse a pharetra urna. Morbi dui lectus, pharetra nec elementum eget, vulput...</p>
            </div>
            <div class="single_featured_slide"> <a href="pages/single.html"><img src="<?php echo $url_prefix; ?>global/images/567x330x3.jpg" alt=""></a>
          ...
          <div class="single_category wow fadeInDown">
            ...
            <div class="business_category_left wow fadeInDown">
              <ul class="fashion_catgnav">
                <li>
                  <div class="catgimg2_container"> <a href="pages/single.html"><img alt="" src="<?php echo $url_prefix; ?>global/images/390x240x1.jpg"></a> </div>
            ...
            <div class="business_category_right wow fadeInDown">
              <ul class="small_catg">
                <li>
                  <div class="media wow fadeInDown"> <a class="media-left" href="pages/single.html"><img src="<?php echo $url_prefix; ?>global/images/112x112.jpg" alt=""></a>
                ...
                <li>
                  <div class="media wow fadeInDown"> <a class="media-left" href="#"><img src="<?php echo $url_prefix; ?>global/images/112x112.jpg" alt=""></a>
                    <div class="media-body">
            ...
            <div class="games_category">
              <div class="single_category">
                ...
                <ul class="small_catg wow fadeInDown">
                  <li>
                    <div class="media"> <a class="media-left" href="#"><img src="<?php echo $url_prefix; ?>global/images/112x112.jpg" alt=""></a>
                      <div class="media-body">
                        <h4 class="media-heading"><a href="#">Duis condimentum nunc pretium lobortis </a></h4>
                        <div class="comments_box"> <span class="meta_date">14/12/2045</span> <span class="meta_comment"><a href="#">No Comments</a></span> </div>
                      </div>
            ...
            <div class="fashion_category">
              <div class="single_category">
                <div class="single_category wow fadeInDown">
                  ...
                  <ul class="fashion_catgnav wow fadeInDown">
                    <li>
                      <div class="catgimg2_container"> <a href="#"><img alt="" src="<?php echo $url_prefix; ?>global/images/390x240x1.jpg"></a> </div>
                      <h2 class="catg_titile"><a href="#">Aenean mollis metus sit amet ligula adipiscing</a></h2>
                      <div class="comments_box"> <span class="meta_date">14/12/2045</span> <span class="meta_comment"><a href="#">No Comments</a></span> <span class="meta_more"><a  href="#">Read More...</a></span> </div>
                      <p>Nunc tincidunt, elit non cursus euismod, lacus augue ornare metus, egestas imperdiet nulla...</p>
                    </li>
        ...
        <div class="content_bottom_right">
          <div class="single_bottom_rightbar">
            ...
            <ul class="small_catg popular_catg wow fadeInDown">
              <li>
                <div class="media wow fadeInDown"> <a href="#" class="media-left"><img alt="" src="<?php echo $url_prefix; ?>global/images/112x112.jpg"> </a>
                  <div class="media-body">
                    <h4 class="media-heading"><a href="#">Duis condimentum nunc pretium lobortis </a></h4>
